...
%
% example_IRIS_GoPro.m - modified main.m file with data from
% IRIS+ quadrotor; for documentation refer to main.m
%% ------------------------------------------------------------------------
...
ThrustWeightRatio = 2.6; % 2 - minimum
                       % 3 - payload transport
                       % 4 - survaillence
                       % 5+ - aerobatics / hi-speed video
                       % 7+ - racing
PropDiameter_Min = 8; % inch
PropDiameter_Max = 10; % inch
